...
<div class="col-lg-12">
    <div class="card"> 
        <div class="card-body card-block">
            <form action="<?= base_url('admin/event/add'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input required type="text" id="judul_hlmstat" name="nama_event" class="form-control">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                         <input required onChange="lamaEvent()" class="form-control" type="date"   name="tgl_awal"  id="tgl_awal">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                         <input required onChange="lamaEvent()" class="form-control" type="date" name="tgl_akhir"   id="tgl_akhir">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="hidden" name="lama_event" id="input_lama">
                         <input required disabled class="form-control" type="number" min="1" max="365" name="lama_event"   id="lama_event">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <textarea required name="keterangan" id="isi_hlmstat" rows="9" placeholder="Masukkan isi berita ..." class="form-control"></textarea>
                    </div>
                </div>
