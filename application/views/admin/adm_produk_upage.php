    ...
    <div class="card"> 
        ...
        <form action="<?php echo base_url('admin/produk/update'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input value="<?= $produk->harga_satuan ?>" max="9999999" type="number" id="judul_hlmstat" name="harga_satuan" class="form-control">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input value="<?= $produk->berat_satuan ?>" max="999" type="number" id="judul_hlmstat" name="berat_satuan" class="form-control">
